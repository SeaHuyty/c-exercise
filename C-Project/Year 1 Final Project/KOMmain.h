...
void seatKOM(int seats, char *file4, float price, char bus[]){
    time_t t = time(NULL);
...
void KOMmain() {
    ...
    while (choice != 0) {
        ...
        switch (choice) {
            case 1:
                seatKOM(seat1, file1, price1, bus1);
                getch();
                break;
            case 2:
                seatKOM(seat2, file2, price2, bus2);
                getch();
                break;
            case 3:
                seatKOM(seat3, file3, price3, bus3);
                getch();
                break;
            case 4:
                seatKOM(seat4, file4, price4, bus4);
                getch();
                break;
            case 0:
                system("cls");

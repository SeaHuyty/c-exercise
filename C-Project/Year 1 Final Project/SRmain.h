...
void seatSR(int seats, char *file1, float price, char bus[]) {
    time_t t = time(NULL);
...
void SRmain() {
    ...
    while (choice != 0) {
      ...
      switch (choice) {
      case 1:
        seatSR(seat1, file1, price1, bus1);
        getch();
        break;
      case 2:
        seatSR(seat2, file2, price2, bus2);
        getch();
        break;
      case 3:
        seatSR(seat3, file3, price3, bus3);
        getch();
        break;
      case 4:
        seatSR(seat4, file4, price4, bus4);
        getch();
        break;
      case 0:
          system("cls");
